...
def check_format(text):
    ...
    # 5. Estimate Latin words and CJK characters without double-counting.
    cjk_pattern = r"[\u4e00-\u9fff\u3040-\u309f\u30a0-\u30ff]"
    cjk_chars = len(re.findall(cjk_pattern, text))
    non_cjk_text = re.sub(cjk_pattern, " ", text)
    en_words = len(re.findall(r"\b\w+\b", non_cjk_text))
